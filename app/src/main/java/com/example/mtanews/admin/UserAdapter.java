...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnAccept.setOnClickListener(v -> {
            ...
            data[5] = "accept";
            PutData putData = new PutData(URLs.ACCEPTREQUESTS_URL, "POST", field, data);
            if (putData.startPut()) {
        ...
        holder.btnRefuz.setOnClickListener(v -> {
            String[] field = new String[6];
            field[0] = "nume";
            field[1] = "prenume";
            field[2] = "email";
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            super(itemView);
            textViewNumePrenume = itemView.findViewById(R.id.numeprenume);
            textViewEmail = itemView.findViewById(R.id.adresa_email);
            textViewBatalion = itemView.findViewById(R.id.valoarebatalion);
            textViewFacultate = itemView.findViewById(R.id.valoarefacultate);
            btnAccept = itemView.findViewById(R.id.butonAccept);
            btnRefuz = itemView.findViewById(R.id.butonRefuz);
        }
    }
}
